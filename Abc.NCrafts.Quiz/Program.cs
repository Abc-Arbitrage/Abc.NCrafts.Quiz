...
namespace Abc.NCrafts.Quiz
{
    internal class Program
    {
        ...
        private static void RunPerformance2018Benchmarks()
        {
            var types = typeof(Program).Assembly
                                       ...
                                       .Where(type => type.IsPublic
                                                      && type.Namespace != null
                                                      && type.Namespace.StartsWith("Abc.NCrafts.Quiz.Performance2018")
        ...
        private static void RunPerformanceQuestion(string ns, int number, long iterationCount = 2_000_000)
        {
            ...
            var types = typeof(Program).Assembly.GetTypes().Where(x => x.Namespace != null && x.Namespace == $"Abc.NCrafts.Quiz.{ns}.Questions._{number:000}" && !x.IsNested);
